...
public class InputManager : MonoBehaviour
{
    ...
    public float turbo = 1f;                     //this is the variable that the CarController script reads for. 
    public float turboMultiplier = 2;           //this is the variable that changes the multiplier when the turbo key is pressed
    ...
    void Update()
    {
        ...
        {
            turbo = turboMultiplier;            //this changes the turbo float from  a 1 to the turboMultiplier float.
        }           
